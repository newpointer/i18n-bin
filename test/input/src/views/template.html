<div>
    ...
    <p>0 ${_trnc("ключ|ключа|ключей", 0, "ключ воды, приток реки")}</p>
    <p>1 ${_trnc("ключ|ключа|ключей", 1, "ключ воды, приток реки")}</p>
    <p>2 ${_trnc("ключ|ключа|ключей", 2, "ключ воды, приток реки")}</p>
    <p>5 ${_trnc("ключ|ключа|ключей", 5, "ключ воды, приток реки")}</p>
